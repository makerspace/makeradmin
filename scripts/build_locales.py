    ...
    if output_json is not None:
        ...
        for o in output:
            ...
            write_file_unless_unchanged(
                p, json.dumps(o.merged, indent=4, ensure_ascii=False, sort_keys=True) + "\n", all_written_files
            )

        write_file_unless_unchanged(
            os.path.join(output_json, "DO_NOT_EDIT.md"),
...
"""
        ...
        write_file_unless_unchanged(
            os.path.join(output_py, "DO_NOT_EDIT.md"),
            "# These files are automatically generated by the build_locales.py script. Do not edit directly.\n",
            all_written_files,
        )
    ...
    if locale_type_definition_output is not None:
        ...
        try:
            ...
            res = subprocess.run(
                ["npx", "prettier", "--experimental-cli", "--stdin-filepath", locale_type_definition_output],
                check=True,
                stdin=typedef_output.encode("utf-8"),
                capture_output=True,
            )
