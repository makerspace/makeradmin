...
def build_locales(
    ...
    if output_json is not None:
        ...
        path_do_not_edit = os.path.join(output_json, "DO_NOT_EDIT.md")
        with open(path_do_not_edit, "w", encoding="utf-8") as fp:
            fp.write(
                "# These files are automatically generated by the build_locales.py script. Do not edit directly.\n"
            )
        os.chmod(path_do_not_edit, 0o666)

    if output_py is not None:
        make_empty_dir(output_py)
        ...
        for o in output:
            ...
            with open(p, "w", encoding="utf-8") as fp:
                ...
                fp.write(f"LOCALE = {json.dumps(dictionary, indent=4, ensure_ascii=False, sort_keys=True)}")
                fp.write("\n")
        ...
        with open(path_locale_py, "w", encoding="utf-8") as fp:
            fp.write(f"""
...
""")
        ...
        os.chmod(path_locale_py, 0o666)

        path_do_not_edit = os.path.join(output_py, "DO_NOT_EDIT.md")
        with open(path_do_not_edit, "w", encoding="utf-8") as fp:
            fp.write(
                "# These files are automatically generated by the build_locales.py script. Do not edit directly.\n"
            )
        ...
        path_init = os.path.join(output_py, "__init__.py")
        with open(path_init, "w", encoding="utf-8") as fp:
            pass
        os.chmod(path_init, 0o666)
    ...
    if locale_type_definition_output is not None:
        ...
        t = f"""// THIS FILE IS AUTOMATICALLY GENERATED BY THE build_locales.py SCRIPT. DO NOT EDIT.
