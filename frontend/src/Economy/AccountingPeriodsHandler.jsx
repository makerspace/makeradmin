...
// Backbone
import AccountingPeriodsCollection from '../Backbone/Collections/AccountingPeriods'

import EconomyAccountingPeriods from './AccountingPeriods'

import { Link } from 'react-router'

var EconomyAccountingPeriodsHandler = React.createClass({
	render: function()
	{
		return (
			<div>
...
module.exports = EconomyAccountingPeriodsHandler;