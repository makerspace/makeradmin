...
class Test(ApiTest):
    def test_create_and_get(self):
        ...
        entity_id = (
            self.post("/membership/group", entity).expect(code=201, status="created", data=entity).get("data__group_id")
        )
    ...
    def test_update(self):
        ...
        data = (
            self.put(f"/membership/group/{entity_id}", dict(name="arne"))
    ...
    def test_primary_key__created_at_and_updated_at_is_filtered_and_not_used_on_update(self):
        ...
        data = (
            self.put(
                f"/membership/group/{entity_id}",
                dict(name="new_name", group_id=entity_id + 1, created_at=t, updated_at=t),
            )
            .expect(code=200)
            .data
        )
    ...
    def test_pagination_and_sort(self):
        ...
        result = (
            self.get(f"/membership/member?search={firstname}&sort_by=lastname&sort_order=asc&page_size=2")
        ...
        result = (
            self.get(f"/membership/member?search={firstname}&sort_by=lastname&sort_order=asc&page_size=2&page=2")
        ...
        result = (
            self.get(f"/membership/member?search={firstname}&sort_by=lastname&sort_order=desc&page_size=3&page=1")
        ...
        result = (
            self.get(f"/membership/member?search={firstname}&sort_by=lastname&sort_order=desc&page_size=3&page=2")
        ...
        self.get(f"/membership/member?search={firstname}&sort_by=lastname&sort_order=desc&page_size=3&page=0").expect(
            code=422
        )

        self.get(f"/membership/member?search={firstname}&sort_by=lastname&sort_order=desc&page_size=3&page=3").expect(
            code=200, data=[], page=3, page_size=3, last_page=2, total=4
        )
    ...
    def test_expand_includes_data_in_list(self):
        ...
        result = self.get(f"/membership/span?expand=member&search={member.member_id}&page_size=0").expect(code=200).data
