...
class Test(ApiTest):
    def test_basic_operations(self):
        ...
        self.post(f"/membership/group/{related_entity_id}/members/add", {"members": [entity_1_id, entity_2_id]}).expect(
            code=200
        )
    ...
    def test_adding_non_existing_entities_is_ok(self):
        ...
        self.post(
            f"/membership/group/{related_entity_id}/members/add", {"members": [randint(int(1e8), int(9e8))]}
        ).expect(code=200)
    ...
    def test_removing_non_existing_entities_is_ok(self):
        ...
        self.post(
            f"/membership/group/{related_entity_id}/members/remove", {"members": [randint(int(1e8), int(9e8))]}
        ).expect(code=200)
