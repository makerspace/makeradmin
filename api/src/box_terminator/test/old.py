...
from multiaccess.box_terminator import (
    box_terminator_validate,
    get_dates,
    check_status,
    get_storage_info,
    Reason,
...
class Test(ApiTest):
    ...
    def test_box_terminator_validate_creates_box_if_not_exists(self):
        ...
        self.api.post(
            "/multiaccess/box-terminator/validate",
            dict(member_number=member.member_number, storage_type=storage_type, item_label_id=item_label_id),
        ).expect(
            200,
    ...
    def test_box_terminator_validate_creates_temp_if_not_exists_lab_exp(self):
        ...
        self.api.post(
            ...
            dict(
                ...
                fixed_end_date=fixed_end_date.isoformat(),
            ),
        ).expect(
            200,
            data__member_number=member.member_number,
    ...
    def test_box_terminator_validate_uses_existing_box_if_it_exists_box(self):
        ...
        self.api.post(
            "/multiaccess/box-terminator/validate",
            dict(member_number=member.member_number, storage_type=storage_type, item_label_id=item.item_label_id),
        ).expect(200)
