...
class task_statisticsTranslator(Protocol):
    @overload
    def __call__(self, key: Literal["cards.actions","cards.assign","cards.assign_task_modal_title","cards.assign_to_member","cards.cancel","cards.completed_count","cards.last_completed","cards.last_completer","cards.mark_complete","cards.mark_complete_anonymous","cards.mark_complete_for_member","cards.mark_complete_modal_title","cards.never","cards.no_cards","cards.overdue","cards.score","cards.score_for_member","cards.search_member_placeholder","cards.select_member_to_assign","cards.select_member_to_complete","cards.status","cards.task","cards.title","error_loading","loading","member_preferences.count","member_preferences.description","member_preferences.no_data","member_preferences.no_responses","member_preferences.option","member_preferences.percentage","member_preferences.title","task_log.date","task_log.member","task_log.no_logs","task_log.room","task_log.show_only_completed","task_log.status","task_log.task","task_log.title","title","task_statistics:cards.actions","task_statistics:cards.assign","task_statistics:cards.assign_task_modal_title","task_statistics:cards.assign_to_member","task_statistics:cards.cancel","task_statistics:cards.completed_count","task_statistics:cards.last_completed","task_statistics:cards.last_completer","task_statistics:cards.mark_complete","task_statistics:cards.mark_complete_anonymous","task_statistics:cards.mark_complete_for_member","task_statistics:cards.mark_complete_modal_title","task_statistics:cards.never","task_statistics:cards.no_cards","task_statistics:cards.overdue","task_statistics:cards.score","task_statistics:cards.score_for_member","task_statistics:cards.search_member_placeholder","task_statistics:cards.select_member_to_assign","task_statistics:cards.select_member_to_complete","task_statistics:cards.status","task_statistics:cards.task","task_statistics:cards.title","task_statistics:error_loading","task_statistics:loading","task_statistics:member_preferences.count","task_statistics:member_preferences.description","task_statistics:member_preferences.no_data","task_statistics:member_preferences.no_responses","task_statistics:member_preferences.option","task_statistics:member_preferences.percentage","task_statistics:member_preferences.title","task_statistics:task_log.date","task_statistics:task_log.member","task_statistics:task_log.no_logs","task_statistics:task_log.room","task_statistics:task_log.show_only_completed","task_statistics:task_log.status","task_statistics:task_log.task","task_statistics:task_log.title","task_statistics:title"]) -> str: ...
    ...
    @overload
    def __call__(self, key: Literal["cards.showing_scores_for_member","task_statistics:cards.showing_scores_for_member"], *, name: str | int | float) -> str: ...
...
@overload
def translate(key: Literal["cards.actions","cards.assign","cards.assign_task_modal_title","cards.assign_to_member","cards.cancel","cards.completed_count","cards.last_completed","cards.last_completer","cards.mark_complete","cards.mark_complete_anonymous","cards.mark_complete_for_member","cards.mark_complete_modal_title","cards.never","cards.no_cards","cards.overdue","cards.score","cards.score_for_member","cards.search_member_placeholder","cards.select_member_to_assign","cards.select_member_to_complete","cards.status","cards.task","cards.title","error_loading","loading","member_preferences.count","member_preferences.description","member_preferences.no_data","member_preferences.no_responses","member_preferences.option","member_preferences.percentage","member_preferences.title","task_log.date","task_log.member","task_log.no_logs","task_log.room","task_log.show_only_completed","task_log.status","task_log.task","task_log.title","title","task_statistics:cards.actions","task_statistics:cards.assign","task_statistics:cards.assign_task_modal_title","task_statistics:cards.assign_to_member","task_statistics:cards.cancel","task_statistics:cards.completed_count","task_statistics:cards.last_completed","task_statistics:cards.last_completer","task_statistics:cards.mark_complete","task_statistics:cards.mark_complete_anonymous","task_statistics:cards.mark_complete_for_member","task_statistics:cards.mark_complete_modal_title","task_statistics:cards.never","task_statistics:cards.no_cards","task_statistics:cards.overdue","task_statistics:cards.score","task_statistics:cards.score_for_member","task_statistics:cards.search_member_placeholder","task_statistics:cards.select_member_to_assign","task_statistics:cards.select_member_to_complete","task_statistics:cards.status","task_statistics:cards.task","task_statistics:cards.title","task_statistics:error_loading","task_statistics:loading","task_statistics:member_preferences.count","task_statistics:member_preferences.description","task_statistics:member_preferences.no_data","task_statistics:member_preferences.no_responses","task_statistics:member_preferences.option","task_statistics:member_preferences.percentage","task_statistics:member_preferences.title","task_statistics:task_log.date","task_statistics:task_log.member","task_statistics:task_log.no_logs","task_statistics:task_log.room","task_statistics:task_log.show_only_completed","task_statistics:task_log.status","task_statistics:task_log.task","task_statistics:task_log.title","task_statistics:title"]) -> str: ...
...
@overload
def translate(key: Literal["cards.showing_scores_for_member","task_statistics:cards.showing_scores_for_member"], *, name: str | int | float) -> str: ...
