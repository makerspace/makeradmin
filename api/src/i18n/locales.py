...
class brandTranslator(Protocol):
    def __call__(self, key: Literal["makerspace_name","billing_address","email","brand:makerspace_name","brand:billing_address","brand:email"]) -> str: ...
@overload
def translate(key: Literal["makerspace_name","billing_address","email","brand:makerspace_name","brand:billing_address","brand:email"]) -> str: ...
