...
from shop.models import Discount, DiscountProductMapping, Product
...
def get_discount_fraction_off(price_level: PriceLevel) -> DiscountOld:
...
def _query_discount_fraction_off(price_level: PriceLevel) -> DiscountOld:
    if price_level == PriceLevel.Normal:
        return DiscountOld(None, Decimal(0))
