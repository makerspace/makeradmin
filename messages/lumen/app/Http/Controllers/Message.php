	...
	function create(Request $request)
	{
		...
		foreach($json["recipients"] as $recipient)
		{
			...
			if($recipient["type"] == "member")
			{
				...
				$result = $ch->call("GET", "http://makeradmin-apigateway/membership/member/{$recipient["id"]}");
			...
			else if($recipient["type"] == "group")
			{
				...
				$ch = new CurlBrowser;
				// TODO: Gateway from config
				$result = $ch->call("GET", "http://makeradmin-apigateway/membership/group/{$recipient["id"]}/members");
