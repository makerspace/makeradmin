            ...
            <div className="uk-margin-top">
                <form className="uk-form uk-form-stacked" onSubmit={(e) => { e.preventDefault(); onSave(); return false; }}>
                    <fieldset className="uk-margin-top">
                        ...
                        <SelectInput model={product} name="account_id" title="Konto" getLabel={o => o.name} getValue={o => o.id} dataSource={"/webshop/category"} />
                        <TextInput model={product} name="debit" title="debit fraktion (0-1)" type="number" />
                        <TextInput model={product} name="credit" title="credit fraktion (0-1)" type="number" />
                        <SelectInput
                            nullOption={{ id: 0 }}
