...
class AccountingAccount extends CollectionNavigation {
    ...
    componentDidMount() {
        ...
        this.unsubscribe = transactionAccount.subscribe(() => this.setState({ saveEnabled: transactionAccount.canSave() }));
    }
    ...
    render() {
        ...
        return (
            <div>
                ...
                <div className="meep">
                    <form className="uk-form uk-margin-bottom" onSubmit={(e) => { e.preventDefault(); this.createAccount(); return false; }}>
                        <TextInput model={this.transactionAccount} name="account" title="Namn" placeholder="Nummer på nytt konto" />
                        <Textarea model={this.transactionAccount} name="description" title="Beskrivning" placeholder="Beskrivning av nytt konto" />

                        <div className="uk-form-row uk-margin-top">
                            <div className="uk-form-controls">
                                <button className="uk-button uk-button-success uk-float-right" disabled={!saveEnabled}><i className="uk-icon-save" /> {this.transactionAccount.id ? 'Spara nytt konto' : 'Skapa nytt konto'}</button>
                            </div>
                        </div>
                    </form>
                </div>
