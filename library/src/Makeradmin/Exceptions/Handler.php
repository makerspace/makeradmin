...
class Handler extends ExceptionHandler
{
	...
	{
		if($e instanceof \Makeradmin\Exceptions\EntityValidationException)
		{
		...
		else if($e instanceof \Makeradmin\Exceptions\FilterNotFoundException)
		{
			return Response()->json([
				"status"  => "error",
				"column"  => $e->getColumn(),
		...
		else if($e instanceof \Makeradmin\Exceptions\ServiceRequestTimeout)
		{
			// When we're in production we want a generic error message via the API, and not a rendered HTML page
			return Response()->json([
				"status"  => "error",
